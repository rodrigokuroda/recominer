...
public class SqlGenerator {
	...
	public String deleteById(TableDescription table) {
		return DELETE + FROM + table.getSchemaAndName() + whereByIdClause(table);
	}
	...
	public String update(TableDescription table, Map<String, Object> columns) {
		final StringBuilder updateQuery = new StringBuilder("UPDATE " + table.getSchemaAndName() + " SET ");
	...
	public String create(TableDescription table, Map<String, Object> columns) {
		final StringBuilder createQuery = new StringBuilder("INSERT INTO " + table.getSchemaAndName() + " (");
	...
	public String deleteAll(TableDescription table) {
		return DELETE + FROM + table.getSchemaAndName();
	}
