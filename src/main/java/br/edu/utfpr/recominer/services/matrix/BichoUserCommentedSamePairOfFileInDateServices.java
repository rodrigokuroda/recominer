...
import br.edu.utfpr.recominer.util.MatcherUtils;
...
public class BichoUserCommentedSamePairOfFileInDateServices extends AbstractBichoMatrixServices {
    ...
    public void run() {
        ...
        Map<UserToUserEdgeByFilePairDirectional, UserToUserEdgeByFilePairDirectional> result = new HashMap<>();
        ...
        for (Map.Entry<Integer, List<Integer>> entrySet : issuesCommits.entrySet()) {
            ...
            Set<FilePair> tempResultFiles = new HashSet<>();
            ...
            Map<UserToUserEdgeByCommentDirectional, UserToUserEdgeByCommentDirectional> tempResultUsers
                    = new HashMap<>();
...
//                }
                ...
                for (int l = k - 1; l >= 0; l--) {
                    ...
                    UserToUserEdgeByCommentDirectional aux = new UserToUserEdgeByCommentDirectional(
                            authorName1, // name
                            authorEmail1, // email
                            authorName2, // name
                            authorEmail2); // email
            ...
            for (UserToUserEdgeByCommentDirectional users : tempResultUsers.values()) {
                for (FilePair files : tempResultFiles) {
                    UserToUserEdgeByFilePairDirectional aux = new UserToUserEdgeByFilePairDirectional(
                            users.getUser(),
