...
//  private final  DescriptiveStatisticsHelper egoPairsStatistics;
    ...
    protected NetworkMetrics() {
        this.betweennessStatistics = new DescriptiveStatisticsHelper();
        this.closenessStatistics = new DescriptiveStatisticsHelper();
        this.degreeStatistics = new DescriptiveStatisticsHelper();
        this.egoBetweennessStatistics = new DescriptiveStatisticsHelper();
        this.egoSizeStatistics = new DescriptiveStatisticsHelper();
        this.egoTiesStatistics = new DescriptiveStatisticsHelper();
        this.egoDensityStatistics = new DescriptiveStatisticsHelper();
        this.efficiencyStatistics = new DescriptiveStatisticsHelper();
        this.effectiveSizeStatistics = new DescriptiveStatisticsHelper();
        this.constraintStatistics = new DescriptiveStatisticsHelper();
        this.hierarchyStatistics = new DescriptiveStatisticsHelper();
