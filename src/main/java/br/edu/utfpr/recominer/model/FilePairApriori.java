...
public class FilePairApriori {
    ...
    public FilePairApriori(FilePair filePair, long fileIssues, long file2Issues, long filePairIssues, long allIssues) {
        this(filePair.getFile1(), filePair.getFile2(), fileIssues, file2Issues, filePairIssues, allIssues);
    }

    public FilePairApriori(File file, File file2, long fileIssues, long file2Issues, long filePairIssues, long allIssues) {
        this.file = file;
        this.file2 = file2;
