...
public class BichoPairFileDAO {
    ...
    public Set<Committer> selectCommitters(Integer issueId,
    ...
    public Set<Committer> selectCommitters(Collection<Integer> issues,
            String file, String file2) {
    ...
    public Committer selectLastCommitter(String file1,
        ...
        Object[] row = dao.selectNativeOneWithParams(
                SELECT_LAST_COMMITTER_OF_PAIR_FILE, selectParams.toArray());

        return getRowAsCommiter(row);
    }
