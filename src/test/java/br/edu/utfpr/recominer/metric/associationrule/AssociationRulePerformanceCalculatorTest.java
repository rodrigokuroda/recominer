...
public class AssociationRulePerformanceCalculatorTest {
    ...
    public void testCalculeRecallPrecisionForNavigationRules() {
        ...
        final AssociationRulePerformanceCalculator<String> calculator = new AssociationRulePerformanceCalculator<>(transactions, extractedNavigationRules);
    ...
    public void testCalculeRecallPrecisionForNavigationRulesInBean() {
        ...
        final AssociationRulePerformanceCalculator<String> calculatorA = new AssociationRulePerformanceCalculator<>(transactions, extractedNavigationRulesA);
        ...
        final AssociationRulePerformanceCalculator<String> calculatorB = new AssociationRulePerformanceCalculator<>(transactions, extractedNavigationRulesB);
    ...
    public void testCalculeRecallPrecisionForPreventionRules() {
        ...
        final AssociationRulePerformanceCalculator<String> calculator = new AssociationRulePerformanceCalculator<>(transactionsPrevention, extractedPreventionRules);
    ...
    public void testCalculeRecallPrecisionForClosureRules() {
        ...
        final AssociationRulePerformanceCalculator<String> calculatorA = new AssociationRulePerformanceCalculator<>(transactions, extractedClosureRulesA);
        ...
        final AssociationRulePerformanceCalculator<String> calculatorB = new AssociationRulePerformanceCalculator<>(transactions, extractedClosureRulesB);
