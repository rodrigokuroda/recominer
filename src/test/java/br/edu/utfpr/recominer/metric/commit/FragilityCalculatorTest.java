...
import br.edu.utfpr.recominer.metric.commit.FragilityCalculator;
...
public class FragilityCalculatorTest {
    ...
    public void testCalculeBuildingGraphWithoutAddingRoot() {
        ...
        // path = 2 + 1 = 3
        pairFiles.add(new FilePair("A/B/Y", "A/B/D/X"));
        // path = 2 + 4 = 6 (+3 = 9)
        pairFiles.add(new FilePair("A/B/D/X", "A/C/E/F/Z"));
        // path = 3 + 4 = 7 (+9 = 16)
        pairFiles.add(new FilePair("A/C/E/F/Z", "A/B/Y"));
    ...
    public void testCalculeBuildingGraphAddingRoot() {
        ...
        Set<FilePair> pairFiles = new HashSet<>();
        // path = 2 + 1 = 3
        pairFiles.add(new FilePair("root/A/B/Y", "root/A/B/D/X"));
        // path = 2 + 4 = 6 (+3 = 9)
        pairFiles.add(new FilePair("root/A/B/D/X", "root/A/C/E/F/Z"));
        // path = 3 + 4 = 7 (+9 = 16)
        pairFiles.add(new FilePair("root/A/C/E/F/Z", "root/A/B/Y"));
        // fragility = sum(path) / pair of files = 16 / 3 = 5,333.
