...
public class CommunicationNetworkBuilder implements NetworkBuilder {
    ...
    private final CommunicationNetworkRepository communicationNetworkDao;
    private final Set<Issue> noCommenters;

    public CommunicationNetworkBuilder(CommunicationNetworkRepository communicationNetworkDao) {
        this.communicationNetworkDao = communicationNetworkDao;
        this.noCommenters = new HashSet<>();
    }

    @Override
    public Network<String, String> build(final Issue issue, final Commit commit) {
        final List<Commenter> commenters = communicationNetworkDao.selectCommenters(issue, commit);
